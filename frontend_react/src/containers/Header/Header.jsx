...
const Header = () => {
  const { text: tagText } = useTypewriter({
    words: ["Fullstack Developer", "Back-End Developer", "Tech Enthusiast"],
    typeSpeed: 100,
    loop: false,
  });
  ...
  return (
    <div className="app__header app__flex">
        ...
        <div className="app__header-badge">
          <div className="badge-cmp app__flex">
            ...
            <div style={{ marginLeft: 20 }}>
              ...
              <p className="head-text">Iqbal Faisal</p>
            </div>
          </div>
      ...
      >
        {[images.react, images.laravel, images.go].map((circle, index) => (
          <motion.div
