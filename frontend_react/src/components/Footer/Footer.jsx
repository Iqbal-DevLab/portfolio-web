  ...
  return (
    <div className="app__flex app__footer">
      ...
      >
        ...
        >
          <a
            href="https://www.linkedin.com/in/iqbal-f"
            target="_blank"
            rel="noreferrer"
            className="app__flex"
          >
        ...
        >
          <a
            href="https://www.facebook.com/iqbalf06"
            target="_blank"
            rel="noreferrer"
            className="app__flex"
          >
        ...
        >
          <a
            href="https://www.instagram.com/iqblfsl"
            target="_blank"
            rel="noreferrer"
            className="app__flex"
          >
        ...
        >
          <a
            href="https://github.com/iqbalf06"
            target="_blank"
            rel="noreferrer"
            className="app__flex"
          >
